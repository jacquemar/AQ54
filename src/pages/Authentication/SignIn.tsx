...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setIsDisabled(true);
    setTimeout(() => {
      setIsDisabled(false); // Réactive le bouton après 5 secondes
    }, 5000);
    ...
    try {
      ...
      if (error.response) {
        ...
        toast.error(`Erreur de connexion : ${error.response.data.message || 'Nom d\'utilisateur ou mot de passe incorrect'}`);
...
<div className="py-17.5 px-26 text-center">
  ...
  <p className="2xl:px-20">
    Connectez-vous au Dashboard de AQ54 <br />
    Annalysez la qualité de l'air grâce aux capteur SMART188 & SMART189 et l'api de airqino
  </p>
